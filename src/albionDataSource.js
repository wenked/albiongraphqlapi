                    ...
                    case 6:
                        ...
                        mergeWithItems = mergePlayers.map(function (player2) {
                            ...
                            if (player2.killFame > 0) {
                                ...
                                return __assign(__assign({}, player2), { weapon: newplayer_1 !== undefined && newplayer_1.Equipment.MainHand.Type, role: newplayer_1 !== undefined &&
                            ...
                            return __assign(__assign({}, player2), { weapon: newplayer !== undefined && newplayer.Equipment.MainHand.Type, role: newplayer !== undefined && zergUtils_1.getRole(newplayer.Equipment.MainHand.Type), averageIp: newplayer !== undefined && newplayer.AverageItemPower
